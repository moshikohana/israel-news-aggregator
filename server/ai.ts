    ...
    messages: [
      {
        ...
        content:
          ...
          "Always include relevant columns: at minimum full_name, and also include phone, notes, tags, city, region, activists_count, birthday, last_contact_date, family_events when they could be relevant to the question or to suggesting follow-up actions. " +
